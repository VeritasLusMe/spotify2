...
export const SONGS = [
  ...
  },
  {
    ...
    lyrics: [
      { t: 0.17, text: 'You\'ll always be my blue valentine' },
{ t: 6.18, text: 'You\'ll always be my blue valentine' },
{ t: 13.06, text: '식어버린 너의 색은 blue' },
{ t: 16.11, text: '파랗게 멍이 든 my heart' },
{ t: 19.12, text: '몇 번이고 덧이 나 열이 나 lovesick' },
{ t: 23.49, text: '이건 such a bad love' },
{ t: 25.71, text: 'We fight, we sigh, and stop' },
{ t: 27.73, text: '붉게 타오르다 한순간에 식어가' },
{ t: 31.68, text: 'Rewind, rewind, rewind' },
{ t: 33.72, text: '언제 그랬냐는 듯이 또 서롤 찾아' },
{ t: 37.12, text: '깊게 새긴 상처 비친 red blood' },
{ t: 41.20, text: '부서진 forever I can see it now' },
{ t: 44.62, text: 'Can you see it now?' },
{ t: 46.19, text: '우린 마치 broken glass on the ground' },
{ t: 48.68, text: '돌이킬 수 없다 해도 We can figure it out' },
{ t: 51.60, text: 'If this love is over' },
{ t: 55.02, text: '다시 뛰어들어 난' },
{ t: 57.64, text: '이 사랑은 colder' },
{ t: 60.72, text: 'I\'ll keep the fire lit in mine' },
{ t: 63.11, text: 'You\'ll always be my blue valentine' },
{ t: 69.11, text: 'You\'ll always be my blue valentine' },
{ t: 76.32, text: '식어도 타오르는 얼음 속 불꽃' },
{ t: 79.38, text: '아무 겁도 없이 뻗어버린 손' },
{ t: 81.99, text: 'Hot and icy, but I like it' },
{ t: 85.22, text: 'It\'s so you' },
{ t: 88.06, text: '바뀌어 맘의 weather 몰려온 cloud' },
{ t: 92.10, text: '외로운 together I can feel it now' },
{ t: 95.57, text: 'Can you feel it now?' },
{ t: 96.83, text: 'Rollercoaster처럼 우린 정신없이 흔들려도' },
{ t: 99.92, text: '돌아갈 걸 알아 So it doesn\'t matter' },
{ t: 103.76, text: 'You might be my end game' },
{ t: 105.85, text: '대가로 얻은 worst pain' },
{ t: 108.66, text: 'If this love is over' },
{ t: 112.06, text: '다시 뛰어들어 난' },
{ t: 114.67, text: '이 사랑은 colder' },
{ t: 117.71, text: 'I\'ll keep the fire lit in mine' },
{ t: 120.17, text: 'You\'ll always be my blue valentine' },
{ t: 126.11, text: 'You\'ll always be my blue valentine' },
{ t: 133.79, text: '붉고 푸른 사랑이란 bruise' },
{ t: 139.39, text: '낫지는 않길 Cause it\'s you' },
{ t: 144.60, text: 'If this love is over' },
{ t: 147.95, text: '다시 뛰어들어 난' },
{ t: 150.70, text: '이 사랑은 colder' },
{ t: 153.70, text: 'I\'ll keep the fire lit in mine' },
{ t: 156.08, text: 'You\'ll always be my blue valentine' },
{ t: 162.23, text: 'You\'ll always be my blue valentine' },
{ t: 178.78, text: 'Blue valentine' },
    ],
  },
];
